...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, return_all_tokens=None, mask=None, multilevel_ftrs=''):
        
        ml_ftrs_blks = [-1] if multilevel_ftrs=='' else list(map(int, multilevel_ftrs.split('-')))
